import { Fetcher } from './frontend-utils.js'
import { handleFrontendError } from './error-catcher.js'
...
function loadMorePosts(postIndex) {
  ...
  console.log(fetchUrl) // eslint-disable-line no-console
...
window.indexPage = _ => ({
  ...
  shouldShowPost,
  loadMorePosts,
  // Start at 1 as the first page is already loaded.
  page: 1,
  initMediaHandlers,
