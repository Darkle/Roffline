...
fixture`Getting Started`.page`http://0.0.0.0:8080/login`
...
//https://testcafe.io/documentation/402831/guides/basic-guides/test-structure#specify-a-custom-starting-url
test.page`http://0.0.0.0:8080/`('My test', async t => {
